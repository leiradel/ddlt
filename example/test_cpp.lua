...
local expected = {
  ...
  {line = 61, token = [[<string>]], lexeme = [["\a\b\f\n\r\t\v\\\'\"\?\xab\xAB\uabcd\uABCD\U0123abcd\U0123ABCD\033"]]},
  {line = 62, token = [[<widestring>]], lexeme = [[L"wchar_t string"]]},
  {line = 63, token = [[<utf8string>]], lexeme = [[u8"UTF-8 encoded string"]]},
  {line = 64, token = [[<utf16string>]], lexeme = [[u"char16_t string"]]},
  {line = 65, token = [[<utf32string>]], lexeme = [[U"char32_t string"]]},
  {line = 66, token = [[<rawstring>]], lexeme = [[R"raw(raw (!) string)raw"]]},
  {line = 67, token = [[<rawwidestring>]], lexeme = [[LR"raw(raw (!) wchar_t string)raw"]]},
  {line = 68, token = [[<rawwidestring>]], lexeme = [[RL"raw(raw (!) wchar_t string)raw"]]},
  {line = 69, token = [[<rawutf16string>]], lexeme = [[uR"raw(raw (!) char16_t string)raw"]]},
  {line = 70, token = [[<rawutf16string>]], lexeme = [[Ru"raw(raw (!) char16_t string)raw"]]},
  {line = 71, token = [[<rawutf32string>]], lexeme = [[UR"raw(raw (!) char32_t string)raw"]]},
  {line = 72, token = [[<rawutf32string>]], lexeme = [[RU"raw(raw (!) char32_t string)raw"]]},
  {line = 73, token = [[<char>]], lexeme = [['char character']]},
  {line = 74, token = [[<widechar>]], lexeme = [[L'wchar_t character']]},
  {line = 75, token = [[<utf8char>]], lexeme = [[u8'UTF-8 encoded character']]},
  {line = 76, token = [[<utf16char>]], lexeme = [[u'char16_t character']]},
  {line = 77, token = [[<utf32char>]], lexeme = [[U'char32_t character']]},
  {line = 77, token = [[<eof>]], lexeme = [[<eof>]]},
}
