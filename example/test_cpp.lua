...
return function(args)
  ...
  local expected = {
    ...
    {line = 24, token = [[<hexadecimal>]], lexeme = [[0xabcd]]},
    {line = 25, token = [[<hexadecimal>]], lexeme = [[0xABCD]]},
    {line = 26, token = [[<octal>]], lexeme = [[0123]]},
    {line = 27, token = [[<decimal>]], lexeme = [[123]]},
    {line = 28, token = [[<float>]], lexeme = [[1.]]},
    {line = 29, token = [[<float>]], lexeme = [[.1]]},
    {line = 30, token = [[<float>]], lexeme = [[1.1]]},
    {line = 31, token = [[<float>]], lexeme = [[1.f]]},
    {line = 32, token = [[<float>]], lexeme = [[.1f]]},
    {line = 33, token = [[<float>]], lexeme = [[1.1f]]},
    {line = 34, token = [[<float>]], lexeme = [[1.e1]]},
    {line = 35, token = [[<float>]], lexeme = [[.1e1]]},
    {line = 36, token = [[<float>]], lexeme = [[1.1e1]]},
    {line = 37, token = [[<float>]], lexeme = [[1.e1f]]},
    {line = 38, token = [[<float>]], lexeme = [[.1e1f]]},
    {line = 39, token = [[<float>]], lexeme = [[1.1e1f]]},
    {line = 40, token = [[<float>]], lexeme = [[1.l]]},
    {line = 41, token = [[<decimal>]], lexeme = [[1u]]},
    {line = 42, token = [[<decimal>]], lexeme = [[1ul]]},
    {line = 43, token = [[<decimal>]], lexeme = [[1ull]]},
    {line = 44, token = [[<decimal>]], lexeme = [[1l]]},
    {line = 45, token = [[<decimal>]], lexeme = [[1lu]]},
    {line = 46, token = [[<decimal>]], lexeme = [[1llu]]},
    {line = 47, token = [[<decimal>]], lexeme = [[1ULL]]},
